...
├── agent/
│   ├── __init__.py
│   └── router.py                 # Core agent orchestration logic
├── tools/
│   ├── base.py
│   ├── bias.py                   # Cognitive bias detector
│   ├── claim_classifier.py       # Claim structure classifier
│   ├── counterexample.py         # Counterexample generator
│   ├── fallacy.py                # Logical fallacy detector
│   └── registry.py
├── data/
